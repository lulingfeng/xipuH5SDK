...
import com.xipu.h5.sdk.dialog.H5Dialog;
import com.xipu.h5.sdk.util.PermissionsChecker;
import com.xipu.h5.sdk.util.permission.PermissionUtils;
...
//        if (requestCode == PERMISSION_REQUEST_CODE && hasAllPermissionsGranted(grantResults)) {
    ...
    private void createMissingPermissionDialog() {
        ...
        builder.setTitle(SOCommonUtil.S(this, "h5_help")).setMessage(SOCommonUtil.S(this, "h5_help_text")).setConfirm(SOCommonUtil.S(this, "h5_confirm"));
