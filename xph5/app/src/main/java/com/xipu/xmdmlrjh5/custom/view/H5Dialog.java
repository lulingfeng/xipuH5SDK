...
public class H5Dialog extends Dialog {
	...
	public H5Dialog(Context context, int themeResId) {
		super(context, themeResId);
	}

	protected H5Dialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
	...
	public static class Builder {
		...
		public H5Dialog create() {
			LayoutInflater inflater = (LayoutInflater) mContext.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			final H5Dialog xpDialog = new H5Dialog(mContext, SOCommonUtil.getRes4Sty(mContext, "H5Dialog"));
