package com.xipu.xmdmlrjh5.manager;
...
public class TTAdManagerHolder {
    ...
    private void loadInteractionAdInfo(TTAdNative mTTAdNative) {
    ...
    private void loadRewardAdInfo(TTAdNative mTTAdNative) {
    ...
    private void loadFullScreenVideoAdInfo(TTAdNative mTTAdNative) {
