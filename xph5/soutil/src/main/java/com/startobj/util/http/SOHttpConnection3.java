 ...
 */
public class SOHttpConnection3 {
	 ...
	 * @param code
	 */
	private static void codeError(final SOCallBack.SOCommonCallBack<String> commonCallBack, int code) {
